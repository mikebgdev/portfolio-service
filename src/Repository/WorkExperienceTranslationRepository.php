...
class WorkExperienceTranslationRepository extends ServiceEntityRepository
{
    ...
    //    /**
    //     * @return WorkExperienceTranslation[] Returns an array of WorkExperienceTranslation objects
    //     */
    ...
    //    public function findOneBySomeField($value): ?WorkExperienceTranslation
    //    {
    //        return $this->createQueryBuilder('w')
    //            ->andWhere('w.exampleField = :val')
    //            ->setParameter('val', $value)
