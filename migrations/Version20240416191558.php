 ...
 */
final class Version20240416191558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX locale_slug_uidx ON about_me_translation');
        $this->addSql('DROP INDEX locale_slug_uidx ON education_translation');
        $this->addSql('DROP INDEX locale_slug_uidx ON work_experience_translation');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE UNIQUE INDEX locale_slug_uidx ON about_me_translation (locale)');
        $this->addSql('CREATE UNIQUE INDEX locale_slug_uidx ON work_experience_translation (locale)');
        ...
        $this->addSql('CREATE UNIQUE INDEX locale_slug_uidx ON education_translation (locale)');
    }
}
